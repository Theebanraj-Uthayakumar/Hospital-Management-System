    ...
    <div className="home">
      ...
      <div className="home-header-img d-flex justify-content-center align-items-center">
        <div className="col-md-6 col-12 home-head">
          ...
          <p>
            Our service center are best of all Other service center.Our dental
            care No 1 of the city
          </p>
        </div>
      </div>
      ...
      <div className="container ">
        <div className="row ">
          <div className="col-md-4 col-lg-4 col-12 home-team p-4 text-white">
            ...
            <span>
              Our beliefs and values dictate our professional culture, and thus
              our professional behaviour. We Believe That our professionalism
              and dental services will enrich people's lives & health
            </span>
            <br />
            <br />
            <Link to="/about">
          ...
          <div className="col-md-4 col-lg-4 col-12 home-service p-4 text-white">
            ...
            <span>
              Comprehensive dental care simplifies maintaining a healthy mouth,
              which will lead to a healthier body in general. We can treat your
              teeth and gums without having to refer you to countless
              specialists.
            </span>
            <br />
            <br />
          ...
          <div className="col-md-4 col-lg-4 col-12 home-team p-4 text-white">
            ...
            <span>
              Are you looking for information on comprehensive dental care? This
              dental term is used to describe an all-inclusive way to take care
              of someone’s oral health. <br />{" "}
            </span>
            <br />
            <br />
            <Link to="/contact">
